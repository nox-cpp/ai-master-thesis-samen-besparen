...
for arg in $@ ; do
    if [[ $arg == "--skip-setup" ]]; then
        ...
        echo "This script runs the importance mapping exploration experiment"
...
# population folders
EXPERIMENT_BASE_NAME=importance_space
...
# we reuse the mapping space script for setup
...
POPULATION_LIST_FILE=$EXPERIMENT_FOLDER/generated/populations_imp.lst
