...
input_populations <- grep(
  "(bn_batch_one|ipf_batch_one)", dir(input_population_dir, full.names = TRUE),
  value = TRUE
)

# prepare our output directory
output_population_dir <-
  file.path(data_dir, "generated", "experiments", "synth_pops", "populations")
